      ...
      <div class="login-box-from">
        <el-form :model="registerForm" :rules="rules" ref="registerForm"  class="demo-ruleForm">
          ...
          <el-form-item prop="password">
            <el-input :type="passw" v-model="registerForm.password"  placeholder="请输入密码" size="medium" >
              <i slot="suffix" :class="icon1" @click="showPass"></i>
              <el-button slot="prepend" icon="el-icon-key"></el-button>
            </el-input>
          </el-form-item>
          <el-form-item prop="repassword">
            <el-input :type="repassw" v-model="registerForm.repassword"  placeholder="请重复密码" size="medium" >
              <i slot="suffix" :class="icon2" @click="showRepass"></i>
              <el-button slot="prepend" icon="el-icon-key"></el-button>
            </el-input>
          </el-form-item>
...
<script>
  export default {
    ...
    methods:{
      ...
      showRepass(){
        if(this.repassw=="text"){
          this.repassw="password";
